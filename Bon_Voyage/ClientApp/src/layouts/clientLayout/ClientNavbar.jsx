...
import sygnet from '../../assets/img/logo.svg'
    ...
    return (
      <React.Fragment>
        ...
        <Nav className="d-md-down-none" navbar>
          ...
          <NavItem className="px-3">
            <Link to="/users" className="nav-link">Де нас знайти</Link>
          </NavItem>
          <NavItem className="px-3">
            <NavLink to="#" className="nav-link">Контакти</NavLink>
          </NavItem>
        </Nav>
        <Nav className="ml-auto" navbar>
          ...
          <UncontrolledDropdown nav direction="down">
            <DropdownToggle nav>
              <img src={image} className="img-avatar" alt="manager@bootstrapmaster.com" />
            </DropdownToggle>
            <DropdownMenu right>
